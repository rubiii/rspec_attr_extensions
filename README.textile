...
h3. Verify that the TestClass contains an attr_reader (for one or more given fields)

bc. describe TestClass do
  it_should_have_an_attr_reader_for :user_id, :admin
end

h3. Verify that the TestClass contains an attr_writer (for one or more given fields)

bc. describe TestClass do
  it_should_have_an_attr_writer_for :admin
end

h3. Verify that the TestClass contains an attr_accessor (for one or more given fields)
